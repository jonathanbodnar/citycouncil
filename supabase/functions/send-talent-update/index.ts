  ...
  const shoutoutCardHtml = `
    <tr>
      <td style="padding-top: 16px;">
        <a href="https://shoutout.us/${talent.username || ''}?utm_source=bio&utm_medium=fanemail&utm_campaign=shoutout_card" target="_blank" style="text-decoration: none; display: block;">
          <!--[if mso]>
