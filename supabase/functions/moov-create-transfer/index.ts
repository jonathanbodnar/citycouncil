...
serve(async req => {
  ...
  try {
    ...
    // Get the source (ShoutOut) account's wallet or bank account
    // First, list payment methods for our facilitator account
    ...
    // Find our wallet or bank account as source
