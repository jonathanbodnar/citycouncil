...
const Footer: React.FC = () => {
  return (
    <footer className="glass border-t border-white/10 backdrop-blur-xl text-white pb-20 md:pb-0">
      {/* Desktop Footer - Full */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-4">
                <a 
                  href="https://www.facebook.com/shoutoutvoice" 
                  target="_blank"
                ...
                <a 
                  href="https://x.com/shoutoutvoices" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors"
                >
                ...
                <a 
                  href="https://www.instagram.com/shoutoutvoice" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors"
                >
