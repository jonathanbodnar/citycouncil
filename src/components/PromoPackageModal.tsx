...
const PromoPackageModal: React.FC<PromoPackageModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[10000] p-4">
      <div 
        className="glass-strong rounded-3xl shadow-2xl border border-white/30 max-w-2xl w-full max-h-[90vh] overflow-y-auto"
        style={{
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 right-4 p-2 rounded-full glass hover:glass-strong transition-all duration-200"
        >
        ...
        <div className="text-center p-8 pb-6">
          <div className="flex justify-center mb-4">
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-r from-red-600 to-blue-600 p-4 rounded-full">
          ...
          <h2 className="text-4xl font-bold text-white mb-2 flex items-center justify-center gap-3">
            ...
            Exclusive Offers for Talent!
            <SparklesIcon className="h-8 w-8 text-yellow-400" />
          </h2>
          
          {!loading && spotsRemaining > 0 && (
            <div className="inline-block mt-4">
              <div className="glass-strong px-6 py-3 rounded-full border border-red-500/50">
              ...
              <div className="flex-1">
                ...
                <div className="space-y-2 text-gray-200">
                  <p className="flex items-center gap-2">
                    ...
                    <strong className="text-green-400">0% Platform Fee</strong> on your first 10 orders
                  </p>
                  <p className="flex items-center gap-2">
                    <span className="text-green-400">✓</span>
                    <strong>Keep 100%</strong> of your earnings (minus charity if set)
                  </p>
          ...
          <div className="glass rounded-2xl p-6 border border-blue-500/30">
            <div className="flex items-start gap-4">
              <div className="text-5xl">
                <MegaphoneIcon className="h-12 w-12 text-blue-400" />
              </div>
              <div className="flex-1">
                ...
                <div className="space-y-3 text-gray-200">
                  <div className="glass-subtle rounded-xl p-4 border border-blue-500/20">
                    <p className="font-bold text-blue-400 text-lg mb-1">
                  ...
                  <div className="text-sm space-y-2">
                    ...
                    <ul className="space-y-1 ml-4">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-blue-400 mt-0.5">→</span>
                        <span>Post promo video on Instagram stories 2x/month</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-blue-400 mt-0.5">→</span>
                        <span>Post 1 ShoutOut video/month (collab @shoutoutvoice)</span>
                      </li>
                    </ul>
                  </div>
          ...
          <div className="space-y-3 pt-4">
            {spotsRemaining > 0 ? (
              <button
                ...
                disabled={claiming}
                className="w-full bg-gradient-to-r from-red-600 to-blue-600 text-white py-4 px-6 rounded-2xl font-bold text-lg hover:from-red-700 hover:to-blue-700 transition-all duration-300 shadow-2xl hover:shadow-red-500/50 disabled:opacity-50 disabled:cursor-not-allowed"
                style={{
              ...
              <div className="w-full bg-gray-600 text-white py-4 px-6 rounded-2xl font-bold text-lg text-center opacity-50 cursor-not-allowed">
                😢 All Spots Taken
              </div>
            )}
            ...
            <button
              onClick={handleDismiss}
              className="w-full glass hover:glass-strong text-white py-3 px-6 rounded-2xl font-medium transition-all duration-200 border border-white/30"
            >
              Maybe Later
            </button>
