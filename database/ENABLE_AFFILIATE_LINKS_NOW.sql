...
COMMENT ON COLUMN bio_links.discount_amount IS 'Discount percentage or text (e.g., "20% OFF")';
COMMENT ON COLUMN bio_links.discount_code IS 'Discount code (e.g., "SAVE20") - shows with discount_amount in badge';
