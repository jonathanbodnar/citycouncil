-- Migration: Add W-9 storage and payout onboarding progress tracking
-- Date: 2024-11-18
-- Description: Create tables for W-9 storage, payout onboarding progress, and admin W-9 management
...
-- Create trigger for w9_forms updated_at
